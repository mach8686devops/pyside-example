...
CMainWindow::CMainWindow(QWidget* parent, CSplashScreen* pSplashScreen) : 
	QMainWindow(parent) {

	connect(this, &CMainWindow::progress, 
			pSplashScreen, &CSplashScreen::setProgress);
