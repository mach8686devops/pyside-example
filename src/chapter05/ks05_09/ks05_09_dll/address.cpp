...
void CWidgetAddress::slot_btnSaveClicked(){
    ...
    QString str = m_pUi->m_lineEdit->text();
    CCustomEvent* pEvent = new CCustomEvent();
    pEvent->setFileName(str);

    QCoreApplication::postEvent(parent(), pEvent);
}
