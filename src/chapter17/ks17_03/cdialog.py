...
from PyQt5.QtGui import QFont, QPainter, QImage, QPolygonF, QPen, QBrush, QLinearGradient, QGradient
...
class CDialog(QDialog, Ui_CDialog) : 
	...
	def paintEvent(self, evt) :		
		...
		# 左侧耳朵
		polygonLeft = QPolygonF ([QPointF(84, 70), QPointF(64, 100), QPointF(84, 130), QPointF(104, 100)])
		painter.drawPolygon(polygonLeft)

		# 右侧耳朵
		polygonRight = QPolygonF ([QPointF(422, 66), QPointF(402, 96), QPointF(422, 126), QPointF(442, 96)])		
		painter.drawPolygon(polygonRight)

		# 嘴巴
		polyline = QPolygonF ([QPointF(154, 146), QPointF(172, 156), QPointF(325, 154), QPointF(344, 135)])
