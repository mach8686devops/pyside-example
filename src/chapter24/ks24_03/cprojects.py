...
class CWidgetProjects(QWidget, Ui_CWidgetProjects): 
	...
	def add(self, strProjectCode):
		...
		widgetbase_workloadProgress.setObjectName(strProjectCode + "_" + "widgetbaseworkloadProgress")
		...
		string = self.tr("Estimated:%d man-day,finished:%d")%(nEstimatedWorkload, finishedWorkLoad)
		...
		graphicsView_workloadProgress.setObjectName(strProjectCode + "_" + "graphicsViewworkloadProgress")
