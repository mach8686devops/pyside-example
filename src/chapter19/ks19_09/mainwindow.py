# -*- coding: utf-8 -*-
from PyQt5.QtWidgets import QMainWindow, QAction, QActionGroup, QMenu, QLabel, QFrame, QMessageBox, QDockWidget, QListWidget
...
from listwidget import CListWidget
import os
...
class CMainWindow(QMainWindow):	
	...
	def createDockWindows(self):
		...
		strList= ["I have learned how to use QDockWidget today.", "Thank for beging with me.","I will make some practice tonight."] 
