...
if __name__ == "__main__":	
	...
	indexSubItem = model.index(int(CTableModel.EAttrIndexAnimate.EattrAnimate_AnimateType), 0, indexItem)
	model.setData(indexSubItem, '类型', Qt.EditRole)
	indexSubItem = model.index(int(CTableModel.EAttrIndexAnimate.EattrAnimate_AnimateSpeed), 0, indexItem)
	...
	indexItem = model.index(int(CTableModel.EAttrIndex.Eattr_Animate), 0, indexRoot)
	indexSubItem = model.index(int(CTableModel.EAttrIndexAnimate.EattrAnimate_AnimateType), 1, indexItem)
	model.setData(indexSubItem, 1, Qt.EditRole)
	indexSubItem = model.index(int(CTableModel.EAttrIndexAnimate.EattrAnimate_AnimateSpeed), 1, indexItem)
